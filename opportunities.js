...
/* ==========================================================
   8. حفظ واسترجاع وعمليات السحابة (Firestore)
   ========================================================== */
...
async function loadSavedData() {
    ...
    try {
        ...
        if (!querySnapshot.empty) {
            ...
            // في حال كانت القاعدة فارغة، جلب نسخة محلية أو إنشاء صف فارغ
            const rawData = localStorage.getItem(STORAGE_KEY);
            if (rawData) {
                // إذا وجدنا بيانات محلية قديمة
            }
        }
    } catch (error) {
        console.error("خطأ في جلب بيانات الفرص من السحابة: ", error);
        const rawData = localStorage.getItem(STORAGE_KEY);
        if (rawData) { 
            // Fallback
        }
