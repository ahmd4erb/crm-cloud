// استيراد خدمات فايربيز المطلوبة من حزمة SDK
...
// إعدادات اتصال فايربيز (تم جلبها من مشروعك)
...
// أسماء المجموعات (Collections) في سحابة فايربيز
...
// جلب سجل النشاط من سحابة فايربيز
...
async function saveNewCustomer() {
  ...
  try {
    // إضافة العميل إلى فايربيز سحابياً
    await addDoc(collection(db, CUSTOMERS_COLLECTION), newCust);
    
    // إضافة الحركة في سجل النشاط السحابي
